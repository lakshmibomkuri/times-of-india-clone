  ...
  return (
    <section className="py-5 border-t border-dashed border-gray-300">
      <div className="max-w-[980px] mx-auto">
        ...
        {/* Grid: Mobile 1-col, Tablet 1-col stacked, Desktop 3-col */}
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <div className="flex gap-3 text-gray-400">
                  <button onClick={prev} aria-label="Previous" className="hover:text-gray-600 transition-colors">
                    ←
                  </button>
                  <button onClick={next} aria-label="Next" className="hover:text-gray-600 transition-colors">
                    →
                  </button>
                </div>
              </div>

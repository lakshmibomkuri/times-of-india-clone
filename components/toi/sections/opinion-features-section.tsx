...
export function OpinionFeaturesSection() {
  ...
  return (
    <section className="border-b border-dashed border-gray-300 mt-5">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 lg:gap-0 mb-4 lg:px-0">
        {/* Section Heading */}
        ...
        <div className="flex gap-4 overflow-x-auto no-scrollbar">
          {tabs.map((tab) => (
            <button
              key={tab}
              onClick={() => setActiveTab(tab)}
              className={`whitespace-nowrap pb-2 text-xs ${
                activeTab === tab
                  ? "text-[#e53935] border-b-2 border-[#e53935]"
                  : "text-gray-700 hover:text-gray-900"
              }`}
      ...
      {/* MAIN GRID: 12 columns */}
      <div className="grid grid-cols-12 gap-6 lg:px-0">
